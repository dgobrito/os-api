package br.com.dgobrito.os.resources;
...
import br.com.dgobrito.os.services.OsService;
...
public class OsResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<OSDTO> update(@PathVariable Integer id, @RequestBody @Valid OSDTO obj) {
